...
<div class="container">
	...
	{#if currentState === "bot check"}
		<div class="bot-box">
			<p>
				Let's make sure you're human. What is <strong
					>{words[numId1]}</strong
				>
				plus <strong>{words[numId2]}</strong>? Enter a single numeral in
				the box below.
			</p>
			<input
				type="number"
	...
	{:else if currentState === "failed"}
		<p>
			Sorry, too many incorrect answers were entered. <strong
				>This trial will not continue.</strong
			>
		</p>
	{/if}
</div>
